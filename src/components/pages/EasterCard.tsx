...
import { Download, CreditCard, Sparkles, Egg, Wallet } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-4 mb-6">
            ...
            <h1 className="text-5xl font-bold" style={{ fontFamily: 'Irys1', letterSpacing: '0.1em' }}>
                ...
                >
                  ...
                  <div className="absolute inset-0 flex flex-col justify-center items-center p-8 z-10">
                    <div className="text-center">
                      ...
                      <p className="name text-2xl font-semibold text-white mb-4 min-h-[2rem] drop-shadow-lg">
                        {userName || 'Your Name'}
                      </p>
                      <p className="message text-lg text-white drop-shadow-lg">
                        Wishing you joy and happiness this Easter season!
                      </p>
                    </div>
                  </div>
                </div>
